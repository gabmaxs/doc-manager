...
<span class="hljs-attr">"description"</span>: {<span class="hljs-attr">"text"</span>: <span class="hljs-string">"..."</span>, <span class="hljs-attr">"sensitive"</span>: <span class="hljs-literal">false</span>}
                ...
                <section class="docs-section" id="item-1-2">
                    ...
                    <figure class="figure docs-figure py-3">
                        <a href="{{asset('template/images/features/appify-theme-projects-overview-lg.jpg')}}" data-title="Image Lightbox Example" data-toggle="lightbox"><img class="figure-img img-fluid shadow rounded" src="assets/images/features/appify-add-members.gif" alt="" style="width: 600px;"></a>
